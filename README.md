...
I've established an initial data pipeline and visualization engine:

**Data Pipeline:** Instead of iterative processing, I used Pandas vectorized operations to map relationships between thousands of stops. 
...
**UI:** Built a frontend using Streamlit and Folium that renders the stops and calculated shortest paths on an interactive map.
